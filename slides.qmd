...
Step 1: filtering using the correlation coefficient. (e.g. trim the "fat"low hanging fruit")
...
CFS + FRE: Remove 20% of variables with lowest correlation, Select best of 20 sized subsets using cross validation
